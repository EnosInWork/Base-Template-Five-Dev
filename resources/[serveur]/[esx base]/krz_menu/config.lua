...
-- GENERAL --
Config.MenuTitle = 'ServerName' -- Vous pouvez changer le nom (exemple : CadmusRP)
Config.DoubleJob = false -- Si vous avez le doublejob veuillez mettre (true)
Config.NoclipSpeed = 1.0 -- Change la vitesse du no-clip
Config.JSFourIDCard = false -- Si vous avez jsfour-idcard vous pouvez l'activé avec (true)
